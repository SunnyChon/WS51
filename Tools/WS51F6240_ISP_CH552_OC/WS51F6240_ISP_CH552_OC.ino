...
//static inline void LED_ON()  { digitalWriteFast(PIN_LED, HIGH); }  // depending on board
//static inline void LED_OFF() { digitalWriteFast(PIN_LED, LOW); }
