...
#line 1 "WS51F0032.c" /0
 ...
 xdata unsigned char P22F	    _at_ 0x8012;	  
 xdata unsigned char P23F	    _at_ 0x8013;	  
 xdata unsigned char P24F	    _at_ 0x8014;	  
 xdata unsigned char P25F	    _at_ 0x8015;	  
 xdata unsigned char P26F	    _at_ 0x8016;	  
 xdata unsigned char P27F	    _at_ 0x8017;	  
 ...
 xdata unsigned char P40F	    _at_ 0x8020;	  
 xdata unsigned char P41F	    _at_ 0x8021;	  
 xdata unsigned char P42F	    _at_ 0x8022;	  
 xdata unsigned char P43F	    _at_ 0x8023;	  
 xdata unsigned char P44F	    _at_ 0x8024;	  
 xdata unsigned char P45F	    _at_ 0x8025;	  
 xdata unsigned char P46F	    _at_ 0x8026;	  
 xdata unsigned char P47F	    _at_ 0x8027;	  
 
 xdata unsigned char P50F	    _at_ 0x8028;	 
 xdata unsigned char P51F	    _at_ 0x8029;     
 xdata unsigned char P52F	    _at_ 0x802a;     
 xdata unsigned char P53F	    _at_ 0x802b;     
 xdata unsigned char P54F	    _at_ 0x802c;     
 xdata unsigned char P55F	    _at_ 0x802d;     
 
 xdata unsigned char T4CON	    _at_ 0x8038;  
 xdata unsigned char T4MOD	    _at_ 0x8039;  
 xdata unsigned char T4RL	    _at_ 0x803a;  
 xdata unsigned char T4RH	    _at_ 0x803b;  
 xdata unsigned char T4CL	    _at_ 0x803c;  
 xdata unsigned char T4CH	    _at_ 0x803d;  
 xdata unsigned char TL4	    	_at_ 0x803e;	 
 xdata unsigned char TH4	    	_at_ 0x803f;	 
 
 
 
 
 
 xdata unsigned char PWMRUN	    _at_ 0x8040;	  
 xdata unsigned char PWMCLR	    _at_ 0x8041;	  
 xdata unsigned char PWMUPD	    _at_ 0x8043;	  
 xdata unsigned char PWMFLG0	    _at_ 0x8044;	  
 xdata unsigned char PWMFLG1	    _at_ 0x8045;	  
 
 xdata unsigned char PMSCON	    _at_ 0x8048;  
 xdata unsigned char PMSDAL	    _at_ 0x8049;  
 xdata unsigned char PMSDAH	    _at_ 0x804a;  
 xdata unsigned char PMSDBL	    _at_ 0x804b;  
 xdata unsigned char PMSDBH	    _at_ 0x804c;  
 ...
 xdata unsigned char PWM1CFG 	_at_ 0x8058;	 
 ...
 xdata unsigned char PWM3CFG 	_at_ 0x8068;	 
 ...
 xdata unsigned char PWM5CFG 	_at_ 0x8078;	 
 ...
 xdata unsigned char FBCON 	_at_ 0x80e0;	 
 xdata unsigned char FBDAT 	_at_ 0x80e1;	 
 xdata unsigned char FBFLG 	_at_ 0x80e2;	 
 xdata unsigned char PMCON 	_at_ 0x80e4;	 
 xdata unsigned char PMDAT 	_at_ 0x80e5;	 
 ...
 xdata unsigned char P4IMSK	_at_ 0x80ed;	 
 xdata unsigned char P5IMSK	_at_ 0x80ee;	 
 
 
 xdata unsigned char BZCON	_at_ 0x80F0;	 
 xdata unsigned char BZPSC	_at_ 0x80F1;	 
 xdata unsigned char BZDUT	_at_ 0x80F2;	 
 xdata unsigned char BZDIV	_at_ 0x80F3;	 
 ...
 xdata unsigned char TKPCS6	  _at_ 0x80fe;	 
 xdata unsigned char TKPCS7	  _at_ 0x80ff;	 
 ...
 xdata unsigned char LXDAT19	_at_ 0x8213;	 
 xdata unsigned char LXDAT20	_at_ 0x8214;	 
 xdata unsigned char LXDAT21	_at_ 0x8215;	 
 xdata unsigned char LXDAT22	_at_ 0x8216;	 
 xdata unsigned char LXDAT23	_at_ 0x8217;	 
 xdata unsigned char LXDAT24	_at_ 0x8218;	 
 xdata unsigned char LXDAT25	_at_ 0x8219;	 
 xdata unsigned char LXDAT26	_at_ 0x821a;	 
 xdata unsigned char LXDAT27	_at_ 0x821b;	 
 
 xdata unsigned char RTCCON	_at_ 0x8280;	 
 xdata unsigned char RTCFLG	_at_ 0x8281;	 
 xdata unsigned char RTCSS	_at_ 0x8282;	 
 xdata unsigned char RTCS	_at_ 0x8283;	 
 xdata unsigned char RTCM	_at_ 0x8284;	 
 xdata unsigned char RTCH	_at_ 0x8285;	 
 xdata unsigned char RTMSS	_at_ 0x8286;	 
 xdata unsigned char RTCDL	_at_ 0x8287;	 
 xdata unsigned char RTCDH	_at_ 0x8288;	 
 xdata unsigned char RTAS	_at_ 0x8289;	 
 xdata unsigned char RTAM	_at_ 0x828a;	 
 xdata unsigned char RTAH	_at_ 0x828b;	 
