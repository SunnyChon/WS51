...
#line 2 "InnerFlashCase.c" /0
 ...
 for(i=0;i<len;++i)
 {
 FSADRL=((StartAddr+i*128)&0xff);
 FSADRH=(((StartAddr+i*128)>>8)&0xff);
 ...
 {
 FSADRL=((WriteAddr+i)&0xff);
 FSADRH=(((WriteAddr+i)>>8)&0xff);
 ...
 FSADRL=(WriteAddr&0xff);
 FSADRH=((WriteAddr>>8)&0xff);
 ...
 {
 FSADRL=((ReadAddr+i)&0xff);
 FSADRH=(((ReadAddr+i)>>8)&0xff);
